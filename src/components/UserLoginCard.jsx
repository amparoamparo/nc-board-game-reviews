  ...
  return (
    <Link to="" onClick={() => handleUserSelection(userOption)}>
      <article
        ...
        className="border rounded-xl overflow-hidden flex flex-col bg-white hover:shadow-md hover:-translate-y-1 transition-all min-h-full p-6 gap-4 items-center active:border-gray-400"
      >
        <img
